...
async def submit_proof(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("📸 Send screenshot of proof:")
...
async def admin_actions(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.text == "📋 Verified IDs":
        await update.message.reply_text(
            "Send:\nUSER_ID\nor\nUSER_ID AMOUNT"
        )
    elif update.message.text == "➕ Add Balance":
        await update.message.reply_text("Send: USER_ID AMOUNT")
    elif update.message.text == "➖ Remove Balance":
        await update.message.reply_text("Send: USER_ID AMOUNT")
    elif update.message.text == "👥 Total Users":
        await update.message.reply_text(f"Total Users: {len(ALL_USERS)}")
    elif update.message.text == "🔍 Check Detail":
...
def main():
    ...
    # Proof conversation (FIXED ENTRY POINT)
